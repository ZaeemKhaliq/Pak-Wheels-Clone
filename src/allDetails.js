...
export const AllDetails = (props) =>{
  ...
  //   color:[{
  //       col: '#152076',
  //       colname: 'Brilliant Blue Metallic'
  //     },{
  //       col: '#C72C3C',
  //       colname: 'Ralley Red'
  //     },{
  //       col: '#999286',
  //       colname: 'Lunar Silver Metallic'
  //     },{
  //       col: '#514B43',
  //       colname: 'Urban titanium'
  //     }],
  ...
  //   color: [{
  //       col: '#2a52be',
  //       colname: 'Cerulean Blue'
  //     },{
  //       col: '#474a51',
  //       colname: 'Graphite Grey'
  //     },{
  //       col: '#ceccb8',
  //       colname: 'Sand Beige'
  //     },{
  ...
  //   });
    ...
    useEffect(() => {
      // db.collection('CarDetails').get().then((snapShot) => {
      //       let c = [];
    ...
    return(
        <div>
        <CarContext.Provider value={[allDetails, setAlldetails]}>
            {props.children}
        </CarContext.Provider>
        </div>
