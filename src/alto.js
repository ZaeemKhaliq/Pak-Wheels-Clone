    ...
    <main>
      ...
      <div style={bodydiv}>
        ...
        <div style={{flex:'0.3',backgroundColor: '#F7F7F7'}}>
          ...
          <p style={{textAlign: 'center',fontSize: 22,fontWeight:'bold'}}>PKR 37-47 lacs</p>

          <div style={sidetab}>
            <p style={p}>MAKE</p>
          </div>
          <p style={{textAlign: 'center',fontSize: 22,fontWeight:'bold'}}>HONDA</p>

          <div style={sidetab}>
            <p style={p}>MODEL</p>
          </div>
          <p style={{textAlign: 'center',fontSize: 22,fontWeight:'bold'}}>CIVIC 2021</p>

          <div style={sidetab}>
            <p style={p}>RATINGS</p>
          </div>
          <p style={{textAlign: 'center',fontSize: 22,fontWeight:'bold'}}>6.0/10.0</p> */}
